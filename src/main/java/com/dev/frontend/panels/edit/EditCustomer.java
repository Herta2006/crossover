...
public class EditCustomer extends EditContentPanel {
    ...
    public boolean bindToGUI(Object o) {
        ...
        txtCode.setText(customer.getId());
        txtName.setText(customer.getOrganizationName());
        txtAddress.setText(customer.getAddress());
        txtPhone1.setText(customer.getPhone1());
        txtPhone2.setText(customer.getPhone2());
        txtCreditLimit.setText("" + (customer.getBalance() / 100.));
        return false;
    }

    public Object guiToObject() {
        Customer customer = new Customer();
        customer.setId(txtCode.getText());
        customer.setOrganizationName(txtName.getText());
        customer.setAddress(txtAddress.getText());
        customer.setPhone1(txtPhone1.getText());
        customer.setPhone2(txtPhone2.getText());
        customer.setBalance((long) (Double.parseDouble(txtCreditLimit.getText()) * 100));
        return customer;
    }
